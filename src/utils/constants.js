...
export const formValidation = (email, password) => {
  ...
  if (!isValidMail) return "Please Enter a Valid E-Mail";
    ...
    return "Your password must contain at least one capital letter, one small letter, one special character, one digit, and be more than 7 characters long ";
  else return null;
};
...
export const API_options = {
  ...
  headers: {
    ...
    Authorization:
      "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJmZjZiOWJkZThhZGMwMTllZTUxNDgxNjUyODAxM2U5YyIsInN1YiI6IjY2MmM5YzZmYTE5OWE2MDEyODcyMDU5NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.v4xD83EDYJopSUel9IMgM2dyTLCFnNkT1I4HHbZ5PKw",
  },
};
...
export const backLogo =
  "https://img.icons8.com/?size=100&id=42470&format=png&color=000000";
